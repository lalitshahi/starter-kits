  ...
  return (
    <div className="w-full flex py-3 items-center">
      ...
      {/* <Image
        ...
        width={160}
        height={80}
        className="mx-5 hidden dark:block"
      />
      <Image
        src={"/starter-kit-dark.png"}
        alt={"logo"}
        width={160}
        height={80}
      ...
      <div className="ml-[auto] space-x-3 flex items-center mr-5">
        <ModeToggle />
        <Button
          asChild
      ...
      {/* Mobile Menu Component Starts */}
      <Menubar className="block md:hidden mr-5">
        <MenubarMenu>
          <MenubarTrigger>
            <AlignJustify className="h-[1.2rem] w-[1.2rem] cursor-pointer" />
          </MenubarTrigger>
